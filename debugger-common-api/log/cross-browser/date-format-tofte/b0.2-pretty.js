/*   0 */ function arrayExists(array, x) {
              for (var i = 0;
                i < array.length;
/*   1 */       i++)
           {
...
/*   6 */         return beat;
              ...
              function j() {
/*   7 */         // Day of the month without leading zeros
                  return self.getDate();
              }    
              function l() {
...
/*   9 */             ) {
              ...
              function m() {
/*  10 */         // Numeric representation of a month, with leading zeros
              ...
              function S() {
/*  11 */         // English ordinal suffix for the day of the month, 2 characters
...
/*  18 */         // we first check, if getFullYear is supported. if it
...
/*  22 */         var diff = self.getTime() - t.getTime();
