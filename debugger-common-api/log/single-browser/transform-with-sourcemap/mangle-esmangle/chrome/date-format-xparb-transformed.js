...
Date.parseDate = function (c, a) {
    if (Date.parseFunctions[a] == null) {
        Date.createParser(a);
    }
    var b = Date.parseFunctions[a];
    return Date[b](c);
};
...
Date.prototype.getDayOfYear = function () {
    ...
    for (var a = 0; a < this.getMonth(); ++a) {
        b += Date.daysInMonth[a];
    }
...
Date.prototype.getWeekOfYear = function () {
    ...
    var a = 7 - c.getDay() + 4;
    document.write(a);
    return String.leftPad((b - a) / 7 + 1, 2, '0');
};
